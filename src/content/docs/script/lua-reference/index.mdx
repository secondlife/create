---
title: Lua Reference
description: Complete reference for Lua (Second Life Luau) scripting
---

import { Card, CardGrid } from '@astrojs/starlight/components';

Complete reference documentation for Lua (Second Life Luau), the modern scripting language for Second Life. This section provides detailed specifications for all functions, events, constants, and language features.

## Reference Sections

<CardGrid>
  <Card title="Functions" icon="puzzle">
    Complete library of Lua functions for controlling objects, communication, math, and more.

    [Browse all Lua functions →](/script/lua-reference/functions/)
  </Card>

  <Card title="Events" icon="setting">
    Event handlers that respond to touches, collisions, timers, messages, and world changes.

    [Browse all Lua events →](/script/lua-reference/events/)
  </Card>

  <Card title="Constants" icon="approve-check">
    Predefined constants for vectors, rotations, permissions, and system values.

    [Browse all Lua constants →](/script/lua-reference/constants/)
  </Card>
</CardGrid>
