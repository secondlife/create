...
This comprehensive example demonstrates land ban and pass list management:
...
- Requires full avatar names to work - even for unbanning someone
- This function is typically used alongside llAddToLandBanList and llResetLandBanList
