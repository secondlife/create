...
-----END PUBLIC KEY-----";
        ...
        // Supported algorithms for llVerifyRSA() include:
...
This function can be paired with `llSignRSA` to validate the authenticity of messages from other LSL scripts. Supported hash algorithms are: sha1, sha224, sha256, sha384, sha512.
